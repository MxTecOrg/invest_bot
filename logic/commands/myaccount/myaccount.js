...
const myaccount = async (user_id, chat_id) => {
    ...
    I("balance") + _ + S(lang , "balance") + ": " + user.balance + "\n" +
    I("wallet") + _ + S(lang , "active_investments") + ": " + active_investments + _ + BotDB.get().currency + "\n" +
    I("referral") + _ + S(lang , "ref_earns") + ": " + user.ref_earn;
}
